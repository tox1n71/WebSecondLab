...
public class GetTemplate {
    public static void renderView(HttpServletResponse response, String ctx, ResultData data) throws IOException {
        ...
        out.println("    <title>Результатики</title>");
        out.println("</head>");
        out.println("<body>");
